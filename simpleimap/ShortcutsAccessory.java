...
/**
 * <code>JFileChooser</code> accessory for management of shortcuts to 
...
public class ShortcutsAccessory extends JPanel {
	...
	public static void main(String[] args) {
		//These lines set the Windows look and feel.
		//They are optional and they have been added so that the chooser looks
		//as on Figure 1.
		try {
